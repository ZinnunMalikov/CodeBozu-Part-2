...
atl_url = 'https://time.com/search/?q=donald+trump'
source = requests.get(atl_url).text
soup = BeautifulSoup(source, 'html.parser')

base_soup = soup.find_all('div', class_='headline heading-content-tiny margin-8-bottom media-heading')
...
def work(num_ind):
    ...
    base_text_list = mini_soup.find_all('p')
    text_list = []
...
df.to_csv('Trump_Time_Scrape_Mod1_Pos_Neg.csv', mode='w')
